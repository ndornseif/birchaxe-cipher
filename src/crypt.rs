...
mod unit_tests {
    ...
    static TEST_DATA: [u8; 32] = [0x80, 0xf, 0x6a, 0x56, 0x87, 0xda, 0xa4, 0xda, 0xed, 0x44, 0x47, 0xd9, 0xd1, 0x24, 0x8b, 0xff, 0x93, 0x84, 0xd8, 0xd6, 0x20, 0x4a, 0x5e, 0x27, 0x8a, 0x7b, 0x17, 0x39, 0x31, 0xeb, 0x6a, 0x3c];
    use super::*;
    ...
    fn encrypt_decrypt_block() {
        ...
        let ciphertext = encrypt_block(TEST_DATA, subkeys, test_rounds);
        let plaintext = decrypt_block(ciphertext, subkeys, test_rounds);
        assert_eq!(TEST_DATA, plaintext, "Plaintext changed after encrypting and decrypting.");
    }
    #[test]
